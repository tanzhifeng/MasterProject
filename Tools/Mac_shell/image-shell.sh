#!/bin/sh
# 图片批处理，包含生成 AppIcon、转 PNG、2x 3x 图片等
...
CreateIconImage() {
	...
	icon_image_name=$1
	# icon图片尺寸数组
	icon_array=(20 21 29 30 40 41 50 57 58 59 60 72 76 80 81 87 100 114 120 121 144 152 167 180 1024)
	# 遍历
...
CreateLaunchImage() {
	...
	image_name=$1
	# 图片高度
	w_array=(960 1024 1136 1334 1792 2048 2208 2436 2688)
	# 图片宽度
	h_array=(640 768  640  750  828  1536 1242 1125 1242)
	array_count=${#h_array[@]}
