...
func (o *LogicalClient) init() {
	...
	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_NOTIFY_APPEND_ROOM)] = o.onNotifyRoomAppend
	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_NOTIFY_REMOVE_ROOM)] = o.onNotifyRoomRemove

	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_USER_ENTER)] = o.onUserEnterRoomResult
	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_USER_LEAVE)] = o.onUserLeaveRoomResult

	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_NOTIFY_APPEND_USER)] = o.onNotifyRoomUserAppend
	o.map4Handler[uint32(pt_login.LoginPid_LOGIN_ROOM_NOTIFY_REMOVE_USER)] = o.onNotifyRoomUserRemove

	//o.MapHandler[uint32(pt_gate.GatePt_GT_LOGIN)] = o.On_GT_LoginResult
